    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("virtualkitchendb.users", t => t.userid)
                .Index(t => t.userid);
            
            CreateTable(
                "virtualkitchendb.users",
                c => new
                    {
                        id = c.Int(nullable: false, identity: true),
        ...
        {
            DropForeignKey("virtualkitchendb.recipes", "userid", "virtualkitchendb.users");
            DropForeignKey("virtualkitchendb.my_recipes", "userid", "virtualkitchendb.users");
            DropForeignKey("virtualkitchendb.ingredients", "userid", "virtualkitchendb.users");
            DropForeignKey("virtualkitchendb.devices", "userid", "virtualkitchendb.users");
            DropIndex("virtualkitchendb.recipes", new[] { "userid" });
            DropIndex("virtualkitchendb.my_recipes", new[] { "userid" });
            ...
            DropTable("virtualkitchendb.my_recipes");
            DropTable("virtualkitchendb.ingredients");
            DropTable("virtualkitchendb.users");
